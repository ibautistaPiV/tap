SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='harbor.dhaka.cf-app.com/ibautista/tanzu-java-web-app-source')
LOCAL_PATH = os.getenv("LOCAL_PATH", default='.')
NAMESPACE = os.getenv("NAMESPACE", default='ibautista')
